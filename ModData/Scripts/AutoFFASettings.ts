...
export class AutoFFASettings {
    ...
    // ===============================================================
    // ===           КОЭФФИЦИЕНТ ОЧКОВ СИЛЫ                     ===
    // ===============================================================

    /**
     * Включить ли механику "Коэффициент очков силы".
     * Если включено, у каждого игрока будет свой коэффициент, влияющий на количество получаемых за атаку на него очков.
     */
    public enableStrengthPointsCoefficient: boolean = true;
