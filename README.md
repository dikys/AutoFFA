...
*   **(Интерфейс/QoL)** Улучшено отображение информационных блоков над замками. Теперь, если блок не помещается на экране (уходит за верхнюю границу), он автоматически сдвигается вниз, чтобы оставаться видимым, а не просто исчезает.
